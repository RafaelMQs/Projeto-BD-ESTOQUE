...
<body>
    ...
    <main class="login">
        <div class="login_container">
            ...
            <form action="processo/registrar.php" method="POST" class="login_form">
                ...
                <input type="text" name="nome_register" class="login_input" placeholder="Digite seu Nome" autocomplete="off">
                <span class="login_input-border"></span>
                ...
                <input type="email" name="email_register" class="login_input" placeholder="Digite seu email" autocomplete="off">
                <span class="login_input-border"></span>
...
<?php
    ...
    ?>
         <div class="alert">  
            <span class="fas fa-exclamation-circle"> </span>
            <span class="msg"> Email Existente!</span>
        <div class="close-btn">
          <span class="fas fa-times"> </span>
        </div>
    </div>
